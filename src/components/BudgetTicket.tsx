...
import { faTicket, faCoins, faArrowRotateRight } from '@fortawesome/free-solid-svg-icons'
...
export function BudgetTicket() {
  ...
  return (
    <main className="stage-glow flex min-h-full w-full items-center justify-center px-4 py-8">
      <section className="relative w-full max-w-[340px]" aria-label="Today's budget challenge ticket">
        ...
        <div className="ticket-grain rounded-2xl border-2 border-[var(--gold)] bg-[var(--ticket)] px-5 pb-6 pt-7 shadow-[0_20px_44px_-20px_rgba(0,0,0,0.55)]">
          <div className="flex items-center justify-center gap-2 text-[11px] font-bold uppercase tracking-[0.18em] text-[var(--ink)]/70" style={{ fontFamily: 'var(--font-body)' }}>
          ...
          <header className="text-center">
            <h1 className="text-[22px] leading-none tracking-tight" style={{ fontFamily: 'var(--font-display)', color: 'var(--ink)' }}>
              Budget for Today
            </h1>
            <p className="mt-2 text-[11px] font-bold uppercase tracking-[0.18em] text-[var(--ink)]/70" style={{ fontFamily: 'var(--font-body)' }}>
              {formatTicketDate(now)}
            </p>
          </header>

          <p className="mt-4 text-center text-[11px] font-bold uppercase tracking-[0.2em] text-[var(--ink)]/60" style={{ fontFamily: 'var(--font-body)' }}>
          ...
          <div className="mt-3 flex justify-center">
            {phase === 'done' ? (
              ...
              <p className="text-[10px] uppercase tracking-[0.16em] text-[var(--ink)]/50" style={{ fontFamily: 'var(--font-body)' }}>
